# -*- coding:utf-8 -*-
"""
Django settings for mitiyu project.
...
SECRET_KEY = '_gxohoc1clilyqrg*t#o$mal0vsdgnhtg1!8b9aa$x!p4z87f6'
...
ROOT_URLCONF = 'mitiyu.urls'

WSGI_APPLICATION = 'mitiyu.wsgi.application'
